 ...
 * @since 05.03.2013
 */
public class HoloProgress extends View {
	...
	public HoloProgress(final Context context) {
		this(context, null);
	}
	 ...
	 *            the attrs
	 */
	public HoloProgress(final Context context, final AttributeSet attrs) {
	 ...
	 *            the def style
	 */
	public HoloProgress(final Context context, final AttributeSet attrs, final int defStyle) {
	...
	protected void onDraw(final Canvas canvas) {
		...
		if (mIsMarkerEnabled) {
			...
			canvas.drawLine((float) (mThumbPosX + mThumbRadius / 2 * 1.4), mThumbPosY,
					(float) (mThumbPosX - mThumbRadius / 2 * 1.4), mThumbPosY, mProgressColorPaint);
			canvas.restore();
		}
		...
		tmpRect.left = mThumbPosX - mThumbRadius / 3;
		tmpRect.right = mThumbPosX + mThumbRadius / 3;
		tmpRect.top = mThumbPosY - mThumbRadius / 3;
		tmpRect.bottom = mThumbPosY + mThumbRadius / 3;
		canvas.drawRect(tmpRect, mProgressColorPaint);
		canvas.restore();
	}
